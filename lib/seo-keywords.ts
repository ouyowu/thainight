...
export const SEO_MENU_LINKS: Array<{
  ...
  { label: "Bangkok Nightlife Safety", href: "/bangkok-nightlife-safety", keyword: "bangkok nightlife safety", group: "intent" },
  { label: "Pattaya Nightlife Prices", href: "/pattaya-nightlife-prices", keyword: "pattaya nightlife prices", group: "intent" },
  { label: "Phuket Nightlife Prices", href: "/phuket-nightlife-prices", keyword: "phuket nightlife prices", group: "intent" },
  { label: "Bangkok Nightlife First Timers", href: "/bangkok-nightlife-first-time", keyword: "bangkok nightlife for first timers", group: "intent" },
